<template>
  <v-app>
    ...
    <v-app-bar app light color="#354C43" class="justify-center">
      ...
      <v-btn color="green" class="mx-4 hidden-sm-and-down" @click="AddItem" outlined>Product List</v-btn>

      <!-- User Actions (Desktop) -->
      <v-btn icon class="mx-2 hidden-sm-and-down">
      ...
      <v-btn color="green" class="mx-2 hidden-md-and-up" @click="AddItem" outlined>Product List</v-btn>
    </v-app-bar>
